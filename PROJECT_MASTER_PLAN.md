...
- Hardware acceptance is now machine-checkable with `tools/air56_unoq_build_hardware_report.py` plus `tools/air56_unoq_hardware_acceptance.py`; it still requires real Stage 0-4 board logs.
