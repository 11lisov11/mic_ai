...
- [x] reproducibility: stable_vs_previous=None, sha=32e7a3d7a5fe8d340d92552f96b8b8486edfc184b6997e46ffcc20fa4167f1eb
...
- [x] motor=air56 acceptance_pass=True saving_mean=+1.024% saving_min=+0.901% threshold=+0.500%
- [x] motor=al31 acceptance_pass=True saving_mean=+1.048% saving_min=+0.388% threshold=+0.000%
- [x] motor=ao2 acceptance_pass=True saving_mean=+0.476% saving_min=+0.356% threshold=+0.050%

## Passport
- [x] `passport/passport_compare_3motors.(csv|md|json)`
- [x] passport failures: 0
- [x] passport warnings: 1
