...
Аннотация.
Цель: разработать и экспериментально проверить модельно-независимый алгоритм MIC AI, уменьшающий положительную составляющую входной мощности асинхронного электропривода в установившихся и периодических режимах без передачи параметров двигателя в контур принятия решений.
