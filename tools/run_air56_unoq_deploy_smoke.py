    ...
    steps = [
        _run_step(
            ...
            [
                ...
                "tools/air56_unoq_build_hardware_report.py",
                "tools/air56_unoq_analyze_stage4_ab.py",
                "tools/air56_unoq_validate_hw_binding.py",
                "tools/air56_unoq_hardware_release_gate.py",
                "tools/air56_unoq_package_hardware_release.py",
        ...
        _run_step(
            ...
            [
                ...
                "tests/test_air56_unoq_build_hardware_report.py",
