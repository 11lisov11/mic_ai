...
- Current novelty claim is deliberately limited and machine-checkable: a distinct host-simulated architecture exists; there is still no claim of universal superiority, MCU/HIL readiness, or bench proof.
