...
- AIR56 UNO Q production-critical coverage gate:
  ...
  - current gate: total `>=75%`, protocol/loopback/static/deploy-smoke/stage4-analyzer/hardware-binding/hardware-report/hardware-acceptance `>=95%`, bridge helper/runtime floor `>=75%`
