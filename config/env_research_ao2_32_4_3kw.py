...
# AO2 live pair refreshed on the calibrated nameplate-first branch.
# 2026-05-19 reproducibility audit found the old fw_c scan artifact was stale
# under current Step27 cache rules, so the live supervisor/id_ref candidate was
# retuned and rechecked on the current code.
...
# candidate: config/step27_ao2_current_repro_candidate_20260519.json
# strict artifact: outputs/ao2_current_repro_strict_scan_20260519/ao2_checkpoint_scan_summary.json
