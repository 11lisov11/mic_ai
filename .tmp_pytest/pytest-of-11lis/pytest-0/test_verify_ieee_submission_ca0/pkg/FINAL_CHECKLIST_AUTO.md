...
- step28_dir: `C:\mic_theory\.tmp_pytest\pytest-of-11lis\pytest-0\test_verify_ieee_submission_ca0\pkg`
...
- policy: `C:\mic_theory\.tmp_pytest\pytest-of-11lis\pytest-0\test_verify_ieee_submission_ca0\guardrails_policy.json`
- thresholds: `air56>=+0.500%, al31>=+0.000%, ao2>=+0.050%`
- [x] `derived_ieee/motor_tuning_acceptance_summary.json`
- [x] motor=air56 acceptance_pass=True saving_mean=+0.600% saving_min=+0.600% threshold=+0.500%
- [x] motor=al31 acceptance_pass=True saving_mean=+0.100% saving_min=+0.100% threshold=+0.000%
- [x] motor=ao2 acceptance_pass=True saving_mean=+0.060% saving_min=+0.060% threshold=+0.050%
