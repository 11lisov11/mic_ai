...
- step28_dir: `C:\mic_theory\.tmp_pytest\pytest-of-11lis\pytest-0\test_build_ieee_final_checklis5\pkg6`
...
- [x] reproducibility: stable_vs_previous=True, sha=abc
...
- policy: `C:\mic_theory\.tmp_pytest\pytest-of-11lis\pytest-0\test_build_ieee_final_checklis5\policy.json`
- thresholds: `air56>=+0.500%, al31>=+0.000%, ao2>=+0.200%`
- [x] `derived_ieee/motor_tuning_acceptance_summary.json`
- [x] motor=air56 acceptance_pass=True saving_mean=+0.800% saving_min=+0.700% threshold=+0.500%
- [x] motor=al31 acceptance_pass=True saving_mean=+0.200% saving_min=+0.100% threshold=+0.000%
- [ ] motor=ao2 acceptance_pass=True saving_mean=+0.080% saving_min=+0.060% threshold=+0.200%

## Passport
- [x] `passport/passport_compare_3motors.(csv|md|json)`
- [x] passport failures: 0
- [x] passport warnings: 0
